...
W tym repozytorium znajdują się interaktywne notatniki Jupyter oraz podręczniki w formacie Markdown przygotowane na warsztaty z biblioteki Pandas w ramach szkolenia **[Python Pandas - analiza i wizualizacja danych](https://www.sages.pl/szkolenia/python-pandas)**.
...
## 👨‍🏫 1. `pokazowe/` (Materiały demonstracyjne i podręczniki)
...
1. **[010_Wstep_i_ekosystem_Pandas.ipynb](pokazowe/010_Wstep_i_ekosystem_Pandas.ipynb)** | 📖 **[Podręcznik 010 (MD)](pokazowe/010_Wstep_i_ekosystem_Pandas.md)** — wektoryzacja `np.where`, `np.select`, Copy-on-Write.
...
7. **[070_Wizualizacja_danych_Plotly.ipynb](pokazowe/070_Wizualizacja_danych_Plotly.ipynb)** | 📖 **[Podręcznik 070 (MD)](pokazowe/070_Wizualizacja_danych_Plotly.md)** — szybki `df.plot()` (słupkowy, liniowy, pudełkowy), interaktywne wykresy Plotly Express (`scatter`, w ćwiczeniach `bar`).
...
10. 📑 **[100_Bonus_1_Pandas_Cheat_Sheet.md](pokazowe/100_Bonus_1_Pandas_Cheat_Sheet.md)** — szybka ściąga: najważniejsze metody, składnia, diagnostyka, I/O, selekcja i idiomy PyData.
11. 📦 **[110_Bonus_2_Przydatne_Datasety_Treningowe.md](pokazowe/110_Bonus_2_Przydatne_Datasety_Treningowe.md)** — zestawienie 6 podręcznych zbiorów danych online do prototypowania i ćwiczeń po szkoleniu.

---

## ✍️ 2. `cwiczenia/` (Zadania praktyczne dla kursantów)
...
4. **[010_Zadania_Wstep_i_NumPy.ipynb](cwiczenia/010_Zadania_Wstep_i_NumPy.ipynb)**
5. **[020_Zadania_Wczytywanie_i_eksport.ipynb](cwiczenia/020_Zadania_Wczytywanie_i_eksport.ipynb)**
6. **[030_Zadania_Series.ipynb](cwiczenia/030_Zadania_Series.ipynb)**
7. **[040_Zadania_DataFrame.ipynb](cwiczenia/040_Zadania_DataFrame.ipynb)**
8. **[050_Zadania_Daty_i_szeregi_czasowe.ipynb](cwiczenia/050_Zadania_Daty_i_szeregi_czasowe.ipynb)**
9. **[060_Zadania_Grupowanie_i_laczenie.ipynb](cwiczenia/060_Zadania_Grupowanie_i_laczenie.ipynb)**
10. **[070_Zadania_Wizualizacja.ipynb](cwiczenia/070_Zadania_Wizualizacja.ipynb)**
11. **[080_Zadania_Case_Studies_Domowe.ipynb](cwiczenia/080_Zadania_Case_Studies_Domowe.ipynb)** — 5 zadań olimpijskich oraz dwa zaawansowane projekty domowe: analiza koszykowa (self-merge) oraz detekcja bloków awarii w telemetrii przemysłowej. W notatniku przygotowano przykładowy, działający kod wzorcowy – można od niego zacząć jako punktu wyjścia do dalszych samodzielnych analiz i rozwijania tych zagadnień.
12. **[090_Zadania_Wydajnosc_i_optymalizacja.ipynb](cwiczenia/090_Zadania_Wydajnosc_i_optymalizacja.ipynb)**
